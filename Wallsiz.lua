...
gg.searchNumber("h30 48 2d e9 08 b0 8d e2 00 40 a0 e1 00 00 a0 e3 00 50 a0 e3 ec ee 2c eb 00 0a b7 ee 16 1a 94 ed 00 0a 31 ee 10 0a 01 ee c0 1a b4 ee 10 fa f1 ee 01 50 00 43 05 00 a0 e1 30 88 bd e8 68 00 90 e5 1e ff 2f e1 68 10 80 e5  ", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(16)
...
gg.setRanges(gg.REGION_CODE_APP)
gg.searchNumber("h01 00 A0 E3 1E FF 2F E1 00 40 a0 e1 00 00 a0 e3 00 50 a0 e3 ec ee 2c eb 00 0a b7 ee 16 1a 94 ed 00 0a 31 ee 10 0a 01 ee c0 1a b4 ee 10 fa f1 ee 01 50 00 43 05 00 a0 e1 30 88 bd e8 68 00 90 e5 1e ff 2f e1 68 10 80 e5 ", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(16)
...
function tr2()
gg.setRanges(gg.REGION_JAVA_HEAP | gg.REGION_C_HEAP | gg.REGION_C_ALLOC | gg.REGION_C_DATA | gg.REGION_C_BSS | gg.REGION_PPSSPP | gg.REGION_ANONYMOUS | gg.REGION_JAVA)
